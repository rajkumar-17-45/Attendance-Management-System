...
<head>
    ...
    <link rel="stylesheet"  href="/admin/sam.css" >
   ...
   <div id="header">
    ...
    <div class="main">
        <div class="sidebar">
            ...
            <div href="#" class="pages" id="faculty-details">Faculty</div>
            <div href="#" class="pages" id="student-details">Student</div>
            <div href="#" class="pages" id="course-details">Course</div>
            <div href="#" class="pages" id="subject-details" >Subject</div>
            <div href="#" class="pages"  id="assign-faculty-details">Assign Faculty</div>
        </div>
...
function hideAllSections() {
    const sections = [
        "faculty-dis", "add-faculty", "faculty-content",
        "student-dis", "add-student", "student-content",
        "course-dis", "add-course", "course-content",
        "assign-faculty-dis", "add-assign-faculty", "assign-faculty-content",
        "subject-dis", "add-subject", "subject-content"
    ];
    sections.forEach(id => document.getElementById(id).style.display = "none");
}


document.getElementById("faculty-details").addEventListener('click', displayfac);

function displayfac() {
    hideAllSections();
    document.getElementById("faculty-dis").style.display = "flex";
    displayfactable();
    displayfacinformation();
}

function displayfacinformation() {
    document.getElementById("display-faculty-table").addEventListener('click', displayfactable);
    document.getElementById("display-add-faculty").addEventListener('click', displayfacadd);
}

function displayfactable() {
    document.getElementById("faculty-content").style.display = "block";
    document.getElementById("add-faculty").style.display = "none";
}

function displayfacadd() {
    document.getElementById("add-faculty").style.display = "block";
    document.getElementById("faculty-content").style.display = "none";
}


document.getElementById("student-details").addEventListener('click', displaystu);

function displaystu() {
    hideAllSections();
    document.getElementById("student-dis").style.display = "flex";
    displaystutable();
    displaystuinformation();
}

function displaystuinformation() {
    document.getElementById("display-student-table").addEventListener('click', displaystutable);
    document.getElementById("display-add-student").addEventListener('click', displaystuadd);
}

function displaystutable() {
    document.getElementById("student-content").style.display = "block";
    document.getElementById("add-student").style.display = "none";
}

function displaystuadd() {
    document.getElementById("add-student").style.display = "block";
    document.getElementById("student-content").style.display = "none";
}


document.getElementById("course-details").addEventListener('click', displaycourse);

function displaycourse() {
    hideAllSections();
    document.getElementById("course-dis").style.display = "flex";
    displaycourseinformation();
    displaycoursetable();
}

function displaycourseinformation() {
    document.getElementById("display-course-table").addEventListener('click', displaycoursetable);
    document.getElementById("display-add-course").addEventListener('click', displaycourseadd);
}
...
document.getElementById("assign-faculty-details").addEventListener('click', displayassfac);

function displayassfac() {
    hideAllSections();
    document.getElementById("assign-faculty-dis").style.display = "flex";
    displayassignfacultytable();
    displayassignfacultyinformation();
}

function displayassignfacultyinformation() {
    document.getElementById("display-assign-faculty-table").addEventListener('click', displayassignfacultytable);
    document.getElementById("display-add-assign-faculty").addEventListener('click', displayassfacadd);
}

function displayassignfacultytable() {
...
// Subject Section
document.getElementById("subject-details").addEventListener('click', displaysub);

function displaysub() {
    hideAllSections();
    document.getElementById("subject-dis").style.display = "flex";
    displaysubjecttable();
    displaysubjectinformation();
}

function displaysubjectinformation() {
    document.getElementById("display-subject-table").addEventListener('click', displaysubjecttable);
    document.getElementById("display-add-subject").addEventListener('click', displaysubjectadd);
}
